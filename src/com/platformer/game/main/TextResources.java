...
public static final String HOW_TO_PLAY_PL = "JAK GRAÆ";
...
public static final String ACHIEVEMENTS_PL = "OSI¥GNIÊCIA";
...
public static final String EXIT_PL = "WYJŒCIE";
public static final String EXIT_ENG = "EXIT";


public static final String RESUME_GAME_PL = "WZNÓW GRÊ";
public static final String RESUME_GAME_ENG = "RESUME GAME";

public static final String MAIN_MENU_PL = "MENU G£ÓWNE";
public static final String MAIN_MENU_ENG = "MAIN MENU";

public static final String LEVEL_PL = "POZIOM";
public static final String LEVEL_ENG = "LEVEL";

public static final String COINS_PL = "MONETY";
public static final String COINS_ENG = "COINS";

public static final String SCORE_PL = "WYNIK";
...
public static final String CONNECTION_ERROR_PL = "B³¹d po³¹czenia z serwerem danych...";
public static final String CONNECTION_ERROR_ENG = "Cannot connect to database server...";

public static final String HALL_OF_FAME_COLUMNS_PL = "MIEJSCE    POZIOM         IMIÊ                         CZAS                 WYNIK";
public static final String HALL_OF_FAME_COLUMNS_ENG = "NO.     LEVEL         NAME                         TIME                 SCORE";

public static final String PLAYER_DEAD_PL = "NIE ¯YESZ !";
